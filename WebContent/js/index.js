...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "json/navs.json" //获取菜单json地址json/navs.json
		});
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>最近偶然发现贤心大神的无敌软件开发团队，瞬间被他的完美样式所吸引，虽然功能不算强大，但毕竟是一个刚刚出现的团队，后面会慢慢完善的。</p></div>',
